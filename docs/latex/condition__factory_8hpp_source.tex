...
\DoxyCodeLine{18     \textcolor{keyword}{template}<\textcolor{keyword}{typename} Probability_>}
...
\DoxyCodeLine{37              \textcolor{keyword}{const} \mbox{\hyperlink{classbn_1_1random__variable}{bn::random\_variable<Probability_>}} \&rv,}
...
\DoxyCodeLine{106         \mbox{\hyperlink{classbn_1_1random__variable}{bn::random\_variable<Probability_>}} var;}
