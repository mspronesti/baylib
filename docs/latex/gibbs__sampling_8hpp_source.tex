...
\DoxyCodeLine{36                 >}
\DoxyCodeLine{37         \textcolor{keyword}{class }\mbox{\hyperlink{classbn_1_1inference_1_1gibbs__sampling}{gibbs\_sampling}} : \textcolor{keyword}{public} \mbox{\hyperlink{classbn_1_1inference_1_1parallel__inference__algorithm}{parallel\_inference\_algorithm}}<Network\_>}
\DoxyCodeLine{38         \{}
...
\DoxyCodeLine{41             \textcolor{keyword}{using} \mbox{\hyperlink{classbn_1_1inference_1_1parallel__inference__algorithm}{parallel\_inference\_algorithm<Network\_>::bn}};}
\DoxyCodeLine{42 }
\DoxyCodeLine{43         \textcolor{keyword}{public}:}
\DoxyCodeLine{44             \textcolor{keyword}{explicit} \mbox{\hyperlink{classbn_1_1inference_1_1gibbs__sampling}{gibbs\_sampling}} (}
\DoxyCodeLine{45                     \textcolor{keyword}{const} network\_type \&\mbox{\hyperlink{namespacebn}{bn}},}
\DoxyCodeLine{46                     ulong nsamples,}
\DoxyCodeLine{47                     uint nthreads = 1,}
\DoxyCodeLine{48                     uint seed = 0}
\DoxyCodeLine{49             )}
\DoxyCodeLine{50             : \mbox{\hyperlink{classbn_1_1inference_1_1parallel__inference__algorithm}{parallel\_inference\_algorithm<Network\_>}}(\mbox{\hyperlink{namespacebn}{bn}}, nsamples, nthreads, seed)}
\DoxyCodeLine{51             \{ \}}
\DoxyCodeLine{52 }
\DoxyCodeLine{53         \textcolor{keyword}{private}:}
\DoxyCodeLine{54             \mbox{\hyperlink{classbn_1_1marginal__distribution}{bn::marginal\_distribution<probability\_type>}} sample\_step (}
...
\DoxyCodeLine{59                 ulong nvars = \mbox{\hyperlink{namespacebn}{bn}}.number\_of\_variables();}
\DoxyCodeLine{60                 \textcolor{comment}{// contains, for each variable, the current state value}}
\DoxyCodeLine{61                 \textcolor{keyword}{auto} var\_state\_values = std::vector<bn::state\_t>(nvars);}
\DoxyCodeLine{62 }
\DoxyCodeLine{63                 \mbox{\hyperlink{classbn_1_1random__generator}{bn::random\_generator<probability\_type, Generator\_>}} rnd\_gen(seed);}
\DoxyCodeLine{64                 \mbox{\hyperlink{classbn_1_1marginal__distribution}{bn::marginal\_distribution<probability\_type>}} marginal\_distr(\mbox{\hyperlink{namespacebn}{bn}}.begin(), \mbox{\hyperlink{namespacebn}{bn}}.end());}
\DoxyCodeLine{65 }
...
\DoxyCodeLine{68                     \{}
\DoxyCodeLine{69                         \textcolor{keyword}{auto} sample = \mbox{\hyperlink{classbn_1_1inference_1_1gibbs__sampling_a6b1a6243e5aa5857db56292a0b2af6bd}{sample\_single\_variable}}(n, var\_state\_values, rnd\_gen);}
...
\DoxyCodeLine{74             \}}
\DoxyCodeLine{75 }
\DoxyCodeLine{85             ulong \mbox{\hyperlink{classbn_1_1inference_1_1gibbs__sampling_a6b1a6243e5aa5857db56292a0b2af6bd}{sample\_single\_variable}}(}
\DoxyCodeLine{86                 \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} n,}
\DoxyCodeLine{87                 std::vector<bn::state\_t> \&var\_state\_values,}
\DoxyCodeLine{88                 \mbox{\hyperlink{classbn_1_1random__generator}{bn::random\_generator<probability\_type, Generator\_>}} \&rnd\_gen}
\DoxyCodeLine{89             )}
\DoxyCodeLine{90             \{}
\DoxyCodeLine{91                 \textcolor{keyword}{auto} var = \mbox{\hyperlink{namespacebn}{bn}}[n];}
...
\DoxyCodeLine{109                     samples[i] = \mbox{\hyperlink{classbn_1_1inference_1_1gibbs__sampling_a1a05b417e1a05d2cd573972f898912f9}{get\_probability}}(n, var\_state\_values);}
\DoxyCodeLine{110                     \textcolor{keywordflow}{for}(ulong j : \mbox{\hyperlink{namespacebn}{bn}}.children\_of(n))}
\DoxyCodeLine{111                         samples[i] *= \mbox{\hyperlink{classbn_1_1inference_1_1gibbs__sampling_a1a05b417e1a05d2cd573972f898912f9}{get\_probability}}(j, var\_state\_values);}
\DoxyCodeLine{112                 \}}
...
\DoxyCodeLine{130             \}}
\DoxyCodeLine{131 }
\DoxyCodeLine{137             probability\_type \mbox{\hyperlink{classbn_1_1inference_1_1gibbs__sampling_a1a05b417e1a05d2cd573972f898912f9}{get\_probability}} (}
\DoxyCodeLine{138                 \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} n,}
\DoxyCodeLine{139                 \textcolor{keyword}{const} std::vector<bn::state\_t> \&var\_state\_values}
\DoxyCodeLine{140             )}
\DoxyCodeLine{141             \{}
\DoxyCodeLine{142                 \mbox{\hyperlink{classbn_1_1condition}{bn::condition}} c;}
\DoxyCodeLine{143                 \textcolor{comment}{// builds a condition using parents and}}
\DoxyCodeLine{144                 \textcolor{comment}{// their states}}
\DoxyCodeLine{145                 \textcolor{keywordflow}{for}(\textcolor{keyword}{auto} \& p : \mbox{\hyperlink{namespacebn}{bn}}.parents\_of(n))}
\DoxyCodeLine{146                     c.\mbox{\hyperlink{classbn_1_1condition_ace731b0369dc443b364192007dbbab68}{add}}(}
\DoxyCodeLine{147                             p,}
\DoxyCodeLine{148                             var\_state\_values[p]}
\DoxyCodeLine{149                     );}
\DoxyCodeLine{150 }
\DoxyCodeLine{151                 \textcolor{keyword}{const} \textcolor{keyword}{auto}\& cpt = \mbox{\hyperlink{namespacebn}{bn}}[n].table();}
...
\DoxyCodeLine{157 \} \textcolor{comment}{// namespace bn}}
\DoxyCodeLine{158 }
