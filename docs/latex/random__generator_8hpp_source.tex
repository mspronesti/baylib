...
\DoxyCodeLine{27     \textcolor{keyword}{template}<\textcolor{keyword}{typename} Tp_, \textcolor{keyword}{typename} Generator_=std::mt19937>}
...
\DoxyCodeLine{30                 <}
\DoxyCodeLine{31                         std::is\_integral<Tp_>::value}
\DoxyCodeLine{32                         , std::uniform\_int\_distribution<Tp_>}
\DoxyCodeLine{33                         , std::uniform\_real\_distribution<Tp_>}
...
\DoxyCodeLine{37 }
\DoxyCodeLine{38         Tp_ get\_random(Tp_ from = .0, Tp_ to = 1.) \{}
...
\DoxyCodeLine{41         \}}
\DoxyCodeLine{42 }
\DoxyCodeLine{43         Tp_ operator () (Tp_ from = 0., Tp_ to = 1.) \{}
...
\DoxyCodeLine{54        \}}
\DoxyCodeLine{55 }
\DoxyCodeLine{56        Generator_ gen;}
\DoxyCodeLine{57     \};}
\DoxyCodeLine{58 }
\DoxyCodeLine{59 }
