...
\DoxyCodeLine{27     \textcolor{keyword}{template}<\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} Generator_=std::mt19937>}
...
\DoxyCodeLine{30                 <}
\DoxyCodeLine{31                         std::is\_integral<T>::value}
\DoxyCodeLine{32                         , std::uniform\_int\_distribution<T>}
\DoxyCodeLine{33                         , std::uniform\_real\_distribution<T>}
...
\DoxyCodeLine{37 }
\DoxyCodeLine{38         T get\_random(T from = .0, T to = 1.) \{}
...
\DoxyCodeLine{41         \}}
\DoxyCodeLine{42 }
\DoxyCodeLine{43         T operator () (T from = 0., T to = 1.) \{}
