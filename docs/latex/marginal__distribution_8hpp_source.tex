...
\DoxyCodeLine{26     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Probability>}
...
\DoxyCodeLine{39         \}}
\DoxyCodeLine{40 }
\DoxyCodeLine{41         \textcolor{keywordtype}{void} set(ulong vid, ulong state\_value, Probability p) \{}
...
\DoxyCodeLine{54         \}}
\DoxyCodeLine{55 }
\DoxyCodeLine{56         std::vector<Probability> \&operator[](ulong vid) \{}
...
\DoxyCodeLine{63         \}}
\DoxyCodeLine{64 }
\DoxyCodeLine{65         \textcolor{keywordtype}{void} operator/=(Probability value) \{}
...
\DoxyCodeLine{69         \}}
\DoxyCodeLine{70 }
\DoxyCodeLine{71         \mbox{\hyperlink{classbn_1_1marginal__distribution}{marginal\_distribution<Probability>}} \&operator+=(}
\DoxyCodeLine{72                 \textcolor{keyword}{const} \mbox{\hyperlink{classbn_1_1marginal__distribution}{marginal\_distribution<Probability>}} \&other}
\DoxyCodeLine{73         ) \{}
...
\DoxyCodeLine{93                 \textcolor{keyword}{const} \mbox{\hyperlink{classbn_1_1marginal__distribution}{marginal\_distribution<Probability>}} \&md}
\DoxyCodeLine{94         ) \{}
...
\DoxyCodeLine{106                 Probability sum = std::accumulate(row.begin(), row.end(), 0.0);}
...
\DoxyCodeLine{115         std::vector<std::vector<Probability>> mdistr;}
\DoxyCodeLine{116     \};}
\DoxyCodeLine{117 }
