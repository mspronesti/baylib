...
\DoxyCodeLine{31                 >}
\DoxyCodeLine{32         \textcolor{keyword}{class }\mbox{\hyperlink{classbn_1_1inference_1_1likelihood__weighting}{likelihood\_weighting}} : \textcolor{keyword}{public} \mbox{\hyperlink{classbn_1_1inference_1_1parallel__inference__algorithm}{parallel\_inference\_algorithm}}<Network\_>}
\DoxyCodeLine{33         \{}
...
\DoxyCodeLine{36             \textcolor{keyword}{using} \mbox{\hyperlink{classbn_1_1inference_1_1parallel__inference__algorithm}{parallel\_inference\_algorithm<Network\_>::bn}};}
\DoxyCodeLine{37             \textcolor{keyword}{typedef} std::vector<ulong> pattern\_t;}
\DoxyCodeLine{38         \textcolor{keyword}{public}:}
\DoxyCodeLine{39             \textcolor{keyword}{explicit} \mbox{\hyperlink{classbn_1_1inference_1_1likelihood__weighting}{likelihood\_weighting}}(}
\DoxyCodeLine{40                     \textcolor{keyword}{const} network\_type \& \mbox{\hyperlink{namespacebn}{bn}},}
\DoxyCodeLine{41                     ulong nsamples,}
\DoxyCodeLine{42                     uint nthreads = 1,}
\DoxyCodeLine{43                     uint seed = 0}
\DoxyCodeLine{44             )}
\DoxyCodeLine{45             : \mbox{\hyperlink{classbn_1_1inference_1_1parallel__inference__algorithm}{parallel\_inference\_algorithm<Network\_>}}(\mbox{\hyperlink{namespacebn}{bn}}, nsamples, nthreads, seed)}
\DoxyCodeLine{46             \{ \};}
\DoxyCodeLine{47         \textcolor{keyword}{private}:}
\DoxyCodeLine{48             \mbox{\hyperlink{classbn_1_1marginal__distribution}{bn::marginal\_distribution<probability\_type>}} sample\_step(}
\DoxyCodeLine{49                  ulong nsamples,}
\DoxyCodeLine{50                  uint seed}
\DoxyCodeLine{51             )}
\DoxyCodeLine{52             \{}
\DoxyCodeLine{53                 \mbox{\hyperlink{classbn_1_1marginal__distribution}{bn::marginal\_distribution<probability\_type>}} mdistr(\mbox{\hyperlink{namespacebn}{bn}}.begin(), \mbox{\hyperlink{namespacebn}{bn}}.end());}
\DoxyCodeLine{54                 \mbox{\hyperlink{classbn_1_1random__generator}{bn::random\_generator<probability\_type, Generator\_>}} rnd\_gen(seed);}
\DoxyCodeLine{55 }
...
\DoxyCodeLine{68                 \mbox{\hyperlink{classbn_1_1random__generator}{bn::random\_generator<probability\_type>}} \& rnd\_gen}
\DoxyCodeLine{69             )}
\DoxyCodeLine{70             \{}
\DoxyCodeLine{71 }
\DoxyCodeLine{72                 probability\_type weight = 1.0;}
\DoxyCodeLine{73                 \textcolor{keyword}{auto} pattern = pattern\_t(\mbox{\hyperlink{namespacebn}{bn}}.number\_of\_variables(), 0.0);}
\DoxyCodeLine{74 }
\DoxyCodeLine{75                 \textcolor{keywordflow}{for}(ulong vid = 0; vid < \mbox{\hyperlink{namespacebn}{bn}}.number\_of\_variables(); ++vid)}
\DoxyCodeLine{76                 \{}
\DoxyCodeLine{77                     \textcolor{keyword}{auto} \& var = \mbox{\hyperlink{namespacebn}{bn}}[vid];}
\DoxyCodeLine{78                     \mbox{\hyperlink{classbn_1_1condition}{bn::condition}} parent\_state;}
\DoxyCodeLine{79 }
\DoxyCodeLine{80                     \textcolor{keywordflow}{for}(\textcolor{keyword}{auto} par : \mbox{\hyperlink{namespacebn}{bn}}.parents\_of(vid))}
\DoxyCodeLine{81                         parent\_state.\mbox{\hyperlink{classbn_1_1condition_ace731b0369dc443b364192007dbbab68}{add}}(}
\DoxyCodeLine{82                                 par,}
...
\DoxyCodeLine{128 \} \textcolor{comment}{// namespace bn}}
\DoxyCodeLine{129 }
