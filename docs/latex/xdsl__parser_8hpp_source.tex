...
\DoxyCodeLine{24 }
\DoxyCodeLine{31         \mbox{\hyperlink{classbn_1_1bayesian__network}{bn::bayesian\_network<Probability>}} \mbox{\hyperlink{classbn_1_1xdsl__parser_a8f6275359844dc266ed8d2fc97de5d57}{deserialize}}(\textcolor{keyword}{const} std::string \&fileName) \{}
\DoxyCodeLine{32 }
\DoxyCodeLine{33             \mbox{\hyperlink{classbn_1_1bayesian__network}{bn::bayesian\_network<Probability>}} \mbox{\hyperlink{namespacebn}{bn}};}
...
\DoxyCodeLine{56                 std::vector<Probability> probDistribution;}
...
\DoxyCodeLine{80                         probDistribution = split<Probability>(pStates-\/>value(), [](\textcolor{keyword}{const} std::string \&t)\{return static\_cast<Probability>(std::stod(t));\});}
