...
#define SAMPLES (ulong)10000
#define TOLERANCE 0.05

// Basic starting test
TEST(likelihood_weighting_tests, big_bang_Coma){
    ...
    bn::inference::likelihood_weighting<double> sampling(SAMPLES, THREADS);
...
TEST(likelihood_weighting_tests, big_bang_VentureBNExpanded){
    ...
    bn::inference::likelihood_weighting<float> sampling(SAMPLES, THREADS);
...
TEST(likelihood_weighting_tests, big_bang_Credit){
...
TEST(likelihood_weighting_tests, big_bang_Asia){
...
TEST(likelihood_weighting_tests, big_bang_Hail){
...
TEST(likelihood_weighting_tests, big_bang_Link){
